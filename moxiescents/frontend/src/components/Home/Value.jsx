    ...
    <div className="bg-punga text-white py-12 px-6 md:px-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-6 bg-clay rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm md:text-base font-verdana">
            All our products are crafted with the finest ingredients, ensuring a
        ...
        <div className="p-6 bg-clay rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm md:text-base font-verdana">
            We prioritize your happiness, offering unparalleled customer service
      ...
      <div className="mt-8 text-center">
        <button
          ...
          className="px-8 py-3 bg-white text-punga font-semibold rounded-full shadow-md hover:bg-opacity-90 transition"
        >
          Shop Now
        </button>
      </div>
